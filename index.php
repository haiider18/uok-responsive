...
<html lang="en">
  ...
  <body>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <img src="images\slider0.jpg" alt="Chania">
            </div>
            <div class="item">
              <img src="images\slider1.jpg" alt="Chania">
            </div>
            <div class="item">
              <img src="images\slider2.jpg" alt="Flower" >
            </div>
            <div class="item">
          ...
          <h3 id="sliderfooter">
            <a href="#">Alumini's registeration</a>, <a href="#"><img src="images\linkedIn.png">View UoK's profile</a> <a href="#"><img src="images\fb.jpg"></a> <a href="#" class="twitter-share-button" ><img src="images\twitter.png" style="width:70px"></a>
          </h3>
    ...
    <div id="LatestBlock">
      <div class="container">
        <img src="images\latest.png"> Active Citizen Certificate Course : <a href="#">Advertisement</a> | <a href="#">Brochure</a> | <a href="#">Admission Form</a>
      </div>
    </div>
    <div id="WelcomeBlock" class="container">
        <div class="col-md-2"><img src="images\bg-1.png">&nbsp;&nbsp;&nbsp;<span>Welcome</span></div>
        <div class="col-md-10">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2">
        <img src="images\vc.jpg" class="img-responsive">
        </div>
      </div>
    </div>
